...
if(isset($_GET['gender'])){
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $sqlproduct = "SELECT products.*, Brand.Brand_Name, Brand.img_URL FROM Brand INNER JOIN products ON Brand.Brand_Name LIKE products.Brand WHERE Brand.Brand_Name = '$brandName' AND gender = '$gender'";
